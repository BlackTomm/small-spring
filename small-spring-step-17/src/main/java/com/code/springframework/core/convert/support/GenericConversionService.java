...
import com.code.springframework.core.convert.converter.ConverterRegistry;
...
public class GenericConversionService implements ConversionService, ConverterRegistry {
	...
	private GenericConverter getConverter(Class<?> sourceType, Class<?> targetType) {
		List<Class<?>> sourceCandiadates = getClassHierarchy(sourceType);
		List<Class<?>> targetCandiadates = getClassHierarchy(targetType);

		for (Class<?> sourceCandiadate : sourceCandiadates) {
			for (Class<?> targetCandiadate : targetCandiadates) {
				GenericConverter.ConvertiblePair convertiblePair = new GenericConverter.ConvertiblePair(sourceCandiadate, targetCandiadate);
	...
	private final class ConverterAdapter implements GenericConverter {
		...
		public Object convert(Object source, Class sourceType, Class targetType) {
			return converter.convert(typeInfo);
		}
	}
